    ...
    <div className="container my-3 custom-background">
      ...
      <div className="container">
        <div className="row d-flex flex-row justify-content-center">
          <div className="custom-card-background m-1 py-3 px-5 col-sm-12 d-flex flex-row justify-content-center align-items-center d-flex">
            <div className="custom-card d-flex flex-wrap justify-content-around align-items-center">
              <div className="img-container col-lg-5 col-sm-12">
                <img 
                  src={photoMe} 
                  alt="Photo of me" 
