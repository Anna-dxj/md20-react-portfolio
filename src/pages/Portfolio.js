            ...
            <div className="row d-flex flex-row container justify-content-around py-3 col-sm-12">
                <div className="row d-flex flex-row justify-content-center m-2 py-3 px-4 col-sm-12 col-lg-10 custom-card-background flex-wrap">
                    ...
                    <ProjectCard 
                        ...
                        description="Full stack note-taking application that can be used to write and save notes, track todos, and organize thoughts."
                        development="As the sole developer for this project, it was my primary responsibility to connect the pre-existing frontend to an Express.js backend. This experience with Express.js marked an important milestone in my journey toward becoming a full stack engineer and completely developing a full stack application by allowing me more experience and familiarity with backend technologies. Despite the short timeline of seven days, I successfully created the Note Taker, showcasing my ability to deliver high-quality work efficiently and effectively."
